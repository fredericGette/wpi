...
namespace wpi
{
    ...
    public class USBPipe
    {
        ...
        public int Read(byte[] buffer, int offset, int length)
        {
            ...
            {
                throw new System.Exception("Failed to read from pipe.", e);
            }
        }
        ...
        public IAsyncResult BeginRead(byte[] buffer, int offset, int length, AsyncCallback userCallback, object stateObject)
        {
            ...
            try
            {
                _device.ReadPipeOverlapped(Interface.InterfaceIndex, _pipeInfo.PipeId, buffer, offset, length, result);
            }
            catch (Exception e)
            {
                if (result != null)
        ...
        public int EndRead(IAsyncResult asyncResult)
        {
            ...
            try
            {
                ...
                if (result.Error != null)
                    throw new System.Exception("Asynchronous read from pipe has failed.", result.Error);
        ...
        public void Write(byte[] buffer, int offset, int length)
        {
            ...
            try
            {
                _device.WritePipe(Interface.InterfaceIndex, _pipeInfo.PipeId, buffer, offset, length);
            }
            catch (Exception e)
            {
                byte[] SubBuffer = new byte[(length < 16 ? length : 16)];
                Array.Copy(buffer, offset, SubBuffer, 0, (length < 16 ? length : 16));
                throw new System.Exception("Failed to write to pipe: ", e);
            }
        }
        ...
        public void Abort()
        {
            try
            {
                _device.AbortPipe(Interface.InterfaceIndex, _pipeInfo.PipeId);
            }
            catch (Exception e)
            {
                throw new System.Exception("Failed to abort pipe.", e);
            }
        }
        ...
        public void Flush()
        {
            ...
            try
            {
                _device.FlushPipe(Interface.InterfaceIndex, _pipeInfo.PipeId);
            }
            catch (Exception e)
            {
                throw new System.Exception("Failed to flush pipe.", e);
            }
        }
