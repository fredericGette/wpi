...
namespace wpi
{
    ...
    public class USBPipePolicy
    {
        ...
        public bool AllowPartialReads
        {
            ...
            {
                RequireDirectionIn();
                return _device.GetPipePolicyBool(_interfaceIndex, _pipeID, POLICY_TYPE.ALLOW_PARTIAL_READS);
            }
            set
            {
                RequireDirectionIn();
                _device.SetPipePolicy(_interfaceIndex, _pipeID, POLICY_TYPE.ALLOW_PARTIAL_READS, value);
            }
        }
        ...
        public bool AutoClearStall
        {
            get
            {
                return _device.GetPipePolicyBool(_interfaceIndex, _pipeID, POLICY_TYPE.AUTO_CLEAR_STALL);
            }
            set
            {
                _device.SetPipePolicy(_interfaceIndex, _pipeID, POLICY_TYPE.AUTO_CLEAR_STALL, value);
            }
        }
        ...
        public bool AutoFlush
        {
            ...
            {
                RequireDirectionIn();
                return _device.GetPipePolicyBool(_interfaceIndex, _pipeID, POLICY_TYPE.AUTO_FLUSH); ;
            }
            set
            {
                RequireDirectionIn();
                _device.SetPipePolicy(_interfaceIndex, _pipeID, POLICY_TYPE.AUTO_FLUSH, value);
            }
        }
        /// <summary>
        ...
        public bool IgnoreShortPackets
        {
            ...
            {
                RequireDirectionIn();
                return _device.GetPipePolicyBool(_interfaceIndex, _pipeID, POLICY_TYPE.IGNORE_SHORT_PACKETS); ;
            }
            set
            {
                RequireDirectionIn();
                _device.SetPipePolicy(_interfaceIndex, _pipeID, POLICY_TYPE.IGNORE_SHORT_PACKETS, value);
            }
        }
        ...
        public int PipeTransferTimeout
        {
            get
            {
                return (int)_device.GetPipePolicyUInt(_interfaceIndex, _pipeID, POLICY_TYPE.PIPE_TRANSFER_TIMEOUT);
            }
            set
            {
                if (value < 0)
                    throw new ArgumentOutOfRangeException("Pipe transfer timeout cannot be negative.");
                _device.SetPipePolicy(_interfaceIndex, _pipeID, POLICY_TYPE.PIPE_TRANSFER_TIMEOUT, (uint)value);
            }
        }
        ...
        public bool RawIO
        {
            get
            {
                return _device.GetPipePolicyBool(_interfaceIndex, _pipeID, POLICY_TYPE.RAW_IO); ;
            }
            set
            {
                _device.SetPipePolicy(_interfaceIndex, _pipeID, POLICY_TYPE.RAW_IO, value);
            }
        }
        ...
        public bool ShortPacketTerminate
        {
            ...
            {
                RequireDirectionOut();
                return _device.GetPipePolicyBool(_interfaceIndex, _pipeID, POLICY_TYPE.SHORT_PACKET_TERMINATE); ;
            }
            set
            {
                RequireDirectionOut();
                _device.SetPipePolicy(_interfaceIndex, _pipeID, POLICY_TYPE.SHORT_PACKET_TERMINATE, value);
            }
        }
